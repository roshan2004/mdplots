...
__author__ = 'Roshan Shrestha'
__email__ = 'roshanpra@gmail.com'
...
def plot_data(data, metadata, window=1, interactive=True, outfile=None, 
    ...
    rc('axes', linewidth=4)
    ax.set_xlabel(metadata['labels'].get('xaxis', ''),fontsize=12, fontweight='bold')
    ax.set_ylabel(metadata['labels'].get('yaxis', ''),fontsize=12, fontweight='bold')
    ax.set_title(metadata.get('title', ''),fontsize=20, fontweight='bold')
